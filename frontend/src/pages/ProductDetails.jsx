...
const ProductDetail = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        setLoading(true);
        const response = await api.get(`/products/${id}/`); // ✅ trailing slash
      ...
      <div className="container">
        <nav aria-label="breadcrumb" className="mb-4">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item active">{product?.product_name}</li>
          </ol>
        </nav>
        ...
        <div className="row mb-5">
          <div className="col-lg-6 mb-4">
            <img
              ...
              style={{ maxHeight: "433px", objectFit: "contain" }}
            />
          </div>

          <div className="col-lg-6">
            <h1 className="display-6 fw-bold mb-3">{product?.product_name}</h1>
            ...
            <p className="lead mb-4">{product?.product_description}</p>
